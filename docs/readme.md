...
Если скрипт находит префикс в имени файла, Тогда он добавляет страницу в последовательную навигацию. Если страница пустая вставляет туда шаблонную запись и также добавляет в навигацию. Страницы не отмеченные префиксами азбуки — игнорируются.
...
Cоздайте свой проект в папке `docs`, например для `GitHub Pages`. Страницы которые должны попасть в навигацию отметьте префиксами представленными выше. Из папки проекта запустите в терминале команду:
